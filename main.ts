...
//   constructor(private name: string,private type: string,private rank: number|string,private vip?: boolean){
//     this.name = name;
//     this.type = type;
//     this.rank = rank;
//     this.vip = vip;
...
//     return `${this.vip? 'VIP ': ''}${this.name}, Type Is ${this.type} And Level Is ${this.rank}`
//   }
